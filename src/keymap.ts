...
const keyRows = [
    ...
    [    
        // {bottom_id: "caps-lock", bottom: "caps lock", length: '1-50'},
        {bottom_id: "caps-lock", bottom: "caps lock"},
        {top: "A", bottom: "a"},
        {top: "O", bottom: "o"},
        {top: "E", bottom: "e"},
        {top: "U", bottom: "u"},
    ...
    [
        // {bottom_id: "shift-left", bottom: "shift", length: '1-75'},
        {bottom_id: "shift-left", bottom: "shift"},
        ...
        {top: "V", bottom: "v"},
        {top: "Z", bottom: "z"},
        // {bottom_id: "shift-right", bottom: "shift", length: '1-75'}
